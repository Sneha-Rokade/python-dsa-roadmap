...
def welcome(name):
    print(f"Welcome {name}! Welcome to python Programming")
...
detail(age=25, name="Bob")

def wc(*names):
    for name in names:
        print(f"Welcome {name}! Welcome to python Programming")

wc("Kevin","Jack","Eva", "David")

def cals(a,b):
    return a + b, a - b

sum_of_numbers, diff_of_two_numbers = cals(90,25)
print(f"Sum of two Numbers :  {sum_of_numbers} and differences of two numbers : {diff_of_two_numbers}")

n = lambda x: x - 25
print(f"Lambda example {n(50)}")
...
result = factorial(5)
print(f"The factorial number of 5 is {result}")