...
for i in numbers:
    ...
    print("Current Number ", str(current_number)  + " Previous Number ",  str(previous_number) + " Sum: ", str(sum_of_numbers))
...
for i in range(10):
    sum_of_nums = prev_num + i
    print(f"Current Number {i} previous_number {prev_num} Sum: {sum_of_nums}")
